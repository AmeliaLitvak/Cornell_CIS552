...
def session(bet):
    ...
    Precondition: bet is an int > 0
    """
        #Randomly choose a number 1-8 and Display starting score
    score = random.randint(1,8)
    done = False
    print('Your score is ' + repr(score) + '.')

    #Prompt user to choose a or b or s
    while score < 20 and done == False:
        ...
        if choice == 'a':
            ...
            print('Your score is ' + repr(score) + '.')
        elif choice == 's' or score >= 20:
            done = True
        
    #Print Busted or Quasar
    if score > 20:
        print('You busted.')
    elif score == 20:
        print('Quasar!')
    ...
    X = payout(bet,score)
    if X >= 0:
        print('You won ' + repr(X) + ' credits.')
    elif X < 0:
        print('You lost ' + repr(-X) + ' credits.')
...
def play(credits):
    ...
    Precondition: credits is an int > 0
    """
    print('You have ' + repr(credits) + ' credits.')
    done = False
    ...
    if credits > 0:
        print('You leave with ' + repr(credits) + ' credits.')
    elif credits == 0:
