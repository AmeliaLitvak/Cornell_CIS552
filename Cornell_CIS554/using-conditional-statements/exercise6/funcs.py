...
def first_vowel(s):
    ...
    if introcs.find_str(s,'e',0,result)!=-1:
        #print(s)
        #print(result)
        result=introcs.find_str(s,'e')
    if introcs.find_str(s,'i',0,result)!=-1:
        #print(s)
        #print(result)
        result=introcs.find_str(s,'i')
    if introcs.find_str(s,'o',0,result)!=-1:
        #print(s)
        #print(result)
        result=introcs.find_str(s,'o')
    if introcs.find_str(s,'u',0,result)!=-1:
        #print(s)
        #print(result)
        result=introcs.find_str(s,'u')
    if introcs.find_str(s,'y',1,result)!=-1:
        #print(s)
        #print(result)
...
def pigify(s):
    ...
    if vowel1==0:
        #print(2, s)
        return s+'hay'
    if s[vowel1-1]=='q' and s[vowel1]=='u':
    #if introcs.find_str(s,'q',0,vowel1):
        #print(4, s)
        return s[vowel1+1:]+s[vowel1-1:vowel1+1]+'ay'
    if vowel1>0:
        #print(3, s)
        return s[vowel1:]+s[0:vowel1]+'ay'
