...
def grade_func(file,step=0,outp=sys.stdout):
    ...
    # Brock Schmutzler (11/12/2024): Changed the `good` list and `bad` list
    # to match the test cases that were in the script `exercise2/test.py`.
    # Also added test cases to `exercise2/test.py` that were in the `good`
    # and `bad` lists, so that the "Check It!" button and `python test.py`
    # will now return exactly the same results. This change was made in
    # repsonse to Wrike ticket https://www.wrike.com/open.htm?id=1516824628
    good = ['12,5', '12,0', '11,05', '0,5', '00,5', '0,00005', '12334567,1234456789', '-12,5']
    bads = ['12', '12,-5', ',5', ',05', '12,', ',', '17.0','apple', '12,5.3', '12.5,3', '12,5,3']
